        ...
        <div className="row">
          <div className="blog-card">
            <div className="img-holder">
              <img src={process.env.PUBLIC_URL + '/imgs/blog1.jpg'} alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page" />
            </div>
          ...
          <div className="blog-card">
            <div className="img-holder">
              <img src={process.env.PUBLIC_URL + '/imgs/blog2.jpg'} alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page" />
            </div>
            <div className="content-holder">
          ...
          <div className="blog-card">
            <div className="img-holder">
              <img src={process.env.PUBLIC_URL + '/imgs/blog3.jpg'} alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page" />
            </div>
            <div className="content-holder">
